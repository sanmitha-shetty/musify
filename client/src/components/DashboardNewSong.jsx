  ...
  return (
    <div className="w-full h-full flex flex-row ">
      ...
      <div className="flex w-2/4  flex-col items-center justify-center p-4 border border-gray-300 rounded-md gap-4"> 
        ...
        <div className="relative w-full h-full flex flex-row gap-1 ">

              {/* Song Cover Uploading */}
              <div className="bg-card backdrop-blur-md w-full h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer"> 
                ...
                <>
                  {!songImageCover ? (
                    <FileUploader 
                    updateState ={setsongImageCover} setProgress = {setimageUploadProgress} isLoading ={setisImageLoading} 
                    is isImage={true}/>
                  ) : (
              ...
              <div className="bg-card backdrop-blur-md w-full h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer"> 
                ...
                {!isAudioLoading && (
                  <>
                    {!audioImageCover ? (
                      <FileUploader 
                      updateState ={setaudioImageCover} setProgress = {setaudioUploadingProgress} 
        ...
        <div className=" w-full flex flex-row gap-4">
            ...
            <div className="bg-card backdrop-blur-md w-2/4 h-200 rounded-md border-2 border-dotted border-gray-300 cursor-pointer"> 
                ...
                <>
                  {!artistImageCover ? (
                    <FileUploader 
                    updateState ={setartistImageCover} setProgress = {setartistUploadingProgress} isLoading ={setisArtistUploading} 
                     isImage={true}/>
                  ) : (
                      <div className="relative w-full h-full overflow-hidden rounded-md">
